...
public class Mahen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getmap.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent maper = new Intent(Mahen.this,Showmap.class);
				maper.putExtra("mapvalue", 5);
				startActivity(maper);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_mahen, menu);
		return true;
	}
